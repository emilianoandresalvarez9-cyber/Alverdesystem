...
select is((select count(*)::int from public.product_price_history
  where presentation_id = '00000000-0000-0000-0000-0000000000c3' and sale_price = 3.00), 1,
  'RF-27: el cambio de precio agrega una sola entrada al historial');
