...
select throws_ok(
  $$
    select public.process_offline_sale(jsonb_build_object('localId', gen_random_uuid(), 'deviceId', gen_random_uuid(), 'kind', 'sale',
      'payload', jsonb_build_object('shiftId', '00000000-0000-0000-0000-000000000501',
...
select ok(
  public.process_offline_sale(jsonb_build_object('localId', '80a92d8f-7f55-430c-9f6b-80a22a362fcc', 'deviceId', gen_random_uuid(), 'kind', 'sale',
    'payload', jsonb_build_object('shiftId', '00000000-0000-0000-0000-000000000501', 'totalAmount', 10,
...
code = code.replace('select * from finish();', tests + 'select * from finish();');
